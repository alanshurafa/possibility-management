...
(function () {
  ...
  function buildGraph(registry, rawEdges, layout, archiveManifest) {
    ...
    registry.forEach(function (site) {
      ...
      var node = {
        ...
        archivePath: archiveManifest && archiveManifest[site.slug] ? archiveManifest[site.slug] : "",
  ...
  function showCard(slug) {
    ...
    var archivedPath = node.pathLabel || (node.archivePath ? node.archivePath.replace(/index\.html$/, "") : node.slug + "/");

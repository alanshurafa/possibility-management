...
The universal grounding script applies as always ([ground.html](../Interactive%20Tools/ground.html), Script 1 of the [Solo Centering and Grounding Scripts](../Resources/Solo%20Centering%20and%20Grounding%20Scripts.md)). If you notice you are floating, dissociating, or shutting down: stop, ground, decide.

This course is not therapy. The energetic-body practices are not a treatment for anything. If today's material brings up something larger than the course is built to hold, use the [Referral List](../Resources/Referral%20List.md).

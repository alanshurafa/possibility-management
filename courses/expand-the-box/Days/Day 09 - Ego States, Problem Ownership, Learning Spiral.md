...
> **Grounding.** Script 1 (the 60-second universal script) is in [Solo Centering and Grounding Scripts](../Resources/Solo%20Centering%20and%20Grounding%20Scripts.md). Every gated practice tool in this module carries a **GROUND NOW** button, and the script stands alone at [ground.html](../Interactive%20Tools/ground.html). Know both routes before you start.

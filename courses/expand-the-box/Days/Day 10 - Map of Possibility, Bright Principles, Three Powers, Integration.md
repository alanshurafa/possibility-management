...
| **Videos** | The written module is complete on its own. Videos are optional enrichment: see [Video Manifest](../Resources/Video%20Manifest.md). This module's material is distilled from the Sparks and the Map of Possibility handouts; per-Spark citations appear where a distinction can be traced to its source. |
...
> **Grounding (60 seconds).** Script 1 in [Solo Centering and Grounding Scripts](../Resources/Solo%20Centering%20and%20Grounding%20Scripts.md), also standing alone at [ground.html](../Interactive%20Tools/ground.html).

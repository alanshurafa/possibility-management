...
> **Grounding.** Script 1 (the 60-second universal script) is in [Solo Centering and Grounding Scripts](../Resources/Solo%20Centering%20and%20Grounding%20Scripts.md). The gated practice tool for this module carries a **GROUND NOW** button, and the script stands alone at [ground.html](../Interactive%20Tools/ground.html). Know both routes before you start. You will likely use one of them inside this module.
...
This course is not therapy. The Emotional Healing Process (Module 6) is in scope. Trauma processing is not. If today's material brings up specific traumatic memory, use the [Referral List](../Resources/Referral%20List.md) and bring a qualified clinician alongside.

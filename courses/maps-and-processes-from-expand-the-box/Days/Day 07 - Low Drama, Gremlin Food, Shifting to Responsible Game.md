...
| **Videos** | The written module is complete on its own. Videos are optional enrichment: see [Video Manifest](../Resources/Video%20Manifest.md). |
...
> **Grounding.** Script 1 (the 60-second universal script) is in [Solo Centering and Grounding Scripts](../Resources/Solo%20Centering%20and%20Grounding%20Scripts.md). The gated practice tool for this module carries a **GROUND NOW** button, and the script stands alone at [ground.html](../Interactive%20Tools/ground.html). Know both routes before you start.
...
Run Script 2 (5 min centering) from [Solo Centering and Grounding Scripts](../Resources/Solo%20Centering%20and%20Grounding%20Scripts.md). Then open the module.
...
- **Now:** run **Script 5, the dissolution script (8 min)**, from [Solo Centering and Grounding Scripts](../Resources/Solo%20Centering%20and%20Grounding%20Scripts.md).
...
> **If naming things where you live could be unsafe** (a controlling partner, a household where being seen doing "self-work" has consequences, the intake Screen 4 situation), run this experiment entirely internally: silent naming, no notebook entry at home, capture later in a locked notes app or outside the house. The variant column in the [Experiment Bank](../Resources/Experiment%20Bank.md) lists the lower-stakes version of every experiment in this course. Same rep, different room. Nobody needs to know which version you ran.
